...
## Following this commands 
 ...
 ```
 * docker image build -t "artemis repo from GCP"/artemis:8.0.0 .

 * docker push "artemis repo from GCP"/artemis:8.0.0 
 ...
 * git chekout 8.0.0
 ...
 <img width="1792" alt="8 0 0" src="https://github.com/farrukh90/artemis/assets/80778542/fa249a49-f921-40f0-95a7-764c8e6211eb">
